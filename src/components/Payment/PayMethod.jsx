  ...
  return (
    <div className="pay">
      ...
      <div className="pay__types">
        <div className="pay__type" onClick={() => handleOptionChange('cash')}>
          <button className={`check ${payMethod === 'cash' ? 'checked' : ''}`}>
            {payMethod === 'cash' && (
              <svg
        ...
        <div className="pay__type" onClick={() => handleOptionChange('card')}>
          <button className={`check ${payMethod === 'card' ? 'checked' : ''}`}>
            {payMethod === 'card' && (
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="24"
